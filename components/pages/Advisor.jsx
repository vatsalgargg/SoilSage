...
export default function Advisor() {
  ...
  async function runAnalysis() {
    ...
    try {
      ...
      const cropObj = getAllCrops().find(c => c.name === fieldData.crop_type) || { name: fieldData.crop_type || 'Wheat', category: 'Cereals', waterNeed: 'medium', optimalMoisture: 60, id: 'wheat' }
