...
import { LayoutDashboard, Sprout, Brain, Calendar, History, LogOut, Droplets, Menu, X, ChevronRight, Settings, Globe, BarChart3, Bug, Activity, WifiOff } from 'lucide-react'
        ...
        <div className="sidebar-bottom">
          {!collapsed && (
            <div className="sidebar-user">
              <div className="user-avatar">{profile?.full_name?.[0]?.toUpperCase() || 'F'}</div>
